...
if($id != 0) {
$sql = "SELECT * FROM tab_mobile_feedbacks WHERE supervisor_admin_id='$cid' AND tab_id=$id AND feedback_status='Average'"; $i=1; 
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <div class="col s12 m12 l12">                  
                <?php $sql = "SELECT * FROM tab_mobile_feedbacks WHERE supervisor_admin_id='$cid' AND tab_id=$id AND feedback_status='Average' GROUP BY feedback_option"; $getUsersData1 = $conn->query($sql);?>
                  ...
                  <?php $sql = "SELECT * FROM tab_mobile_feedbacks WHERE supervisor_admin_id='$cid' AND tab_id=$id AND feedback_status='Average' GROUP BY category"; $getUsersData1 = $conn->query($sql);?>
                  <div class="form-group col-md-3">                    
