      ...
      <div class="site-content">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">
            <a href="add_users.php" style="float:right">Add Client Admin</a>
            <h3 class="m-t-0 m-b-5">Client Admin</h3>
          </div>
              ...
              <table class="table table-striped table-bordered dataTable" id="table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php if ($row['status']==0) { echo "<span class='label label-outline-success check_active open_cursor' data-incId=".$row['id']." data-status=".$row['status']." data-tbname='client_admin_users'>Active</span>" ;} else { echo "<span class='label label-outline-info check_active open_cursor' data-status=".$row['status']." data-incId=".$row['id']." data-tbname='client_admin_users'>In Active</span>" ;} ?></td>
                    ...
                    <td><?php if ($row['client_ads_status']==0) { echo "<span class='label label-outline-success check_adds_status open_cursor' data-incId=".$row['id']." data-status=".$row['client_ads_status']." data-tbname='client_admin_users'>Enable</span>" ;} else { echo "<span class='label label-outline-info check_adds_status open_cursor' data-status=".$row['client_ads_status']." data-incId=".$row['id']." data-tbname='client_admin_users'>Disabled</span>" ;} ?></td>
                    <!-- Open Modal Box  here -->
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-body" id="modal_body">
                          <div class="row">
                            ...
                            <div class="col-sm-6"><?php echo $row['client_name'];?></div>
                          </div>
                          <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-4">Email: </div>
                            <div class="col-sm-6"><?php echo $row['client_email'];?></div>
                          </div>
                          <div class="row">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-4">Mobile: </div>
                            <div class="col-sm-6"><?php echo $row['client_mobile'];?></div>
                          </div>
                          <div class="row">
                            <div class="col-sm-2"></div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6"><?php $getStateData =  getDataFromTables('lkp_states',$status=NULL,'id',$row['client_state_id'],$activeStatus=NULL,$activeTop=NULL); $state = $getStateData->fetch_assoc(); echo $state['state_name']?></div>
                          </div>
                          <div class="row">
                            <div class="col-sm-2"></div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-6"><?php $getLocationData =  getDataFromTables('lkp_locations',$status=NULL,'id',$row['client_location_id'],$activeStatus=NULL,$activeTop=NULL); $loaction = $getLocationData->fetch_assoc(); echo $loaction['location_name']?></div>
                          </div>
                          <!-- <div class="row">
                            <div class="col-sm-2"></div>
