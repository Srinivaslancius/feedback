...
$id = $_GET['uid'];
 if (!isset($_POST['submit'])) {
    ...
    //If success            
      ...
      $client_location_id = $_POST['clint_location_id'];
      $client_super_admin_id = encryptPassword($_POST['created_super_admin_id']);
      $client_crreated_at = $_POST['created_at'];
      $status = $_POST['status'];
        $sql = "UPDATE `client_admin_users` SET client_name='$client_name', client_email='$client_email', client_mobile='$client_mobile', client_country_id='$client_country_id', client_state_id='$client_state_id', client_city_id='$client_city_id', clint_location_id='$client_location_id', created_super_admin_id='$client_super_admin_id', created_at='$client_crreated_at', status = '$status' WHERE id = '$id' ";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="POST" autocomplete="off">
                  <div class="form-group">
                    ...
                    <input type="text" name="client_name" class="form-control" id="form-control-2" placeholder="Client Name" data-error="Please enter client name" required value="<?php echo $getUsers1['client_name'];?>">
                  ...
                  <div class="form-group">
                    ...
                    <select id="clint_location_id" name="clint_location_id" class="custom-select" data-error="This field is required." required>
                       <option value="">Select Location</option>
                      <?php while($row = $getLocations->fetch_assoc()) {  ?>
                      <option <?php if($row['id'] == $getUsers1['clint_location_id']) { echo "Selected"; } ?> value="<?php echo $row['id']; ?>"><?php echo $row['location_name']; ?></option>
                      <?php } ?>
                   </select>
                    <div class="help-block with-errors"></div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Super Admin Id</label>
                    <input type="password" name="created_super_admin_id" class="form-control" id="form-control-2" placeholder="super admin id" data-error="Please enter super admin id." required value="<?php echo decryptPassword($getUsers1['created_super_admin_id']);?>">
                    <div class="help-block with-errors"></div>
                  </div>

                  <div class="form-group">
                    <label for="form-control-2" class="control-label">Created At</label>
                    <input type="text" name="created_at" class="form-control" id="form-control-2" placeholder="Client Name" data-error="Please enter created at" required value="<?php echo $getUsers1['created_at'];?>">
                    <div class="help-block with-errors"></div>
                  </div>
