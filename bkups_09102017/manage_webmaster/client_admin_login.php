...
<head>
  ...
  <title>Ixora Client Admin</title>
    ...
    <div class="row">
      <div class="col-sm-4 col-sm-offset-4"  style="background:wheat">
        <div class="authentication-content m-b-30">
          ...
          <form autocomplete="off" method="post" action="client-admin-login-script.php" data-toggle="validator">
            <div class="form-group">
              <label for="form-control-1">Email address</label>
              <input type="email" class="form-control" autofocus="autofocus" id="form-control-2" placeholder="Email" name="client_admin_email" data-error="Please enter a valid email address." required>
              <div class="help-block with-errors"></div>
            </div>
            <div class="form-group">
              <label for="form-control-2">Mobile</label>
              <input type="password" class="form-control" id="form-control-2" placeholder="Mobile" data-error="Please enter mobile." required name="client_admin_mobile">
              <div class="help-block with-errors"></div>
            </div>
