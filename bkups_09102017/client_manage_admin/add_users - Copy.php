...
function addInput(divName) {
    ...
    var selectHTML = "";   
    var newTextBox = ""; 
    selectHTML="<div style='border:1px solid #333;'><div class='input-field form-group col-md-6'><label for='form-control-3' class='control-label'>Choose your Category</label><select required name='category_id[]' id='form-control-3' class='custom-select' style='display:block !important'><option value=''>Select Category</option>";
