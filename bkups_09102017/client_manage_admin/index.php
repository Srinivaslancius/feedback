        ...
        <div class="authentication-content m-b-30">
          ...
          <form autocomplete="off" method="post" action="login-script.php" data-toggle="validator">
            <div class="form-group">
              ...
              <input type="email" class="form-control" autofocus="autofocus" id="form-control-2" placeholder="Email" name="client_email" data-error="Please enter a valid email address." required>
              <div class="help-block with-errors"></div>
            </div>
            <div class="form-group">
              <label for="form-control-2">Mobile</label>
              <input type="password" class="form-control" id="form-control-2" placeholder="Mobile" data-error="Please enter password." required name="client_mobile">
              <div class="help-block with-errors"></div>
            </div>
